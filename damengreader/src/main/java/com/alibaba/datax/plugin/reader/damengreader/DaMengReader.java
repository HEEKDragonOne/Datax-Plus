package com.alibaba.datax.plugin.reader.damengreader;
...
public class DaMengReader extends Reader {
    ...
    public static class Job extends Reader.Job {
        ...
        public void init() {
            ...
            int userConfigedFetchSize = this.originalConfig.getInt(Constant.FETCH_SIZE, 1000);
            if (userConfigedFetchSize < 1) {
                throw DataXException.asDataXException(String.format("您配置的fetchSize有误，fetchSize : [%d] 设置值不能小于 1.", userConfigedFetchSize));
            }
